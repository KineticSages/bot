    ...
    client.on('interactionCreate', async interaction => {
      ...
      try {
        ...
        if (slashCommand.maintenance) {
          return await interaction.reply({
            ephemeral: true,
            content: `${emojis.MESSAGE.x} **${slashCommand.name} Command is under __Maintenance Mode__** Please Try Again Later!`
          })
        }
        // ==============================< Owner Only >============================= \\            
